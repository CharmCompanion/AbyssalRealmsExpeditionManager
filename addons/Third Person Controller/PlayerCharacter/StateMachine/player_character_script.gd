...
@onready var jump_particles = preload("res://addons/Third Person Controller/PlayerCharacter/Vfx/jump_particles.tscn")
@onready var land_particles = preload("res://addons/Third Person Controller/PlayerCharacter/Vfx/land_particles.tscn")
